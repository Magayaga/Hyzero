...
int main() {
    std::cout << "Copyright (c) 2022 Cyril John Magayaga\n";
    std::cout << "All right Reserved\n";
    std::cout << "\n";
    std::cout << "Copyright (c) 2001-2022 Python Software Foundation\n";
    std::cout << "All right Reserved\n";
    std::cout << "\n";
    std::cout << "Use ((./hyzeroHelp or hyzeroHelp.exe)) for more information about that topic.\n";
    return 0;
}